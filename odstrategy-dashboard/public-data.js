window.OD_PUBLIC_DATA = {
  meta: {
    ...
    updated: 'August 19, 2026: SEAP training evidence reconciled to 2.00 verified eligible hours plus 0.22 hour pending; August 18 Entity Formation webinar completion recorded with duration and verification still open'
  },
  metrics: { prospects: 44, pipeline: 6600, trainingLogged: 2.00, trainingPending: 0.22, trainingRequired: 20, contacts: 13 },
  purpose: [
  ...
  milestones: [
    ...
    ['August 13, 2026', 'Business-setup training documented', 'A dated certificate now supports 2.00 hours of in-person SCORE business-setup entrepreneurial training for the first SEAP training benchmark.'],
    ...
    ['August 18, 2026', 'Operating scope and entity-training work advanced', 'The primary launch service was reaffirmed as Podcast Production and Digital Content Support, Voice of Liberty was clarified as a Digital Content & Visibility pilot, and Peter reports completing a VBOC Entity Formation webinar presented by Angela Tylock, Esq. The provider source email is retained, but the webinar duration and individual completion verification remain open before hours can be credited.'],
