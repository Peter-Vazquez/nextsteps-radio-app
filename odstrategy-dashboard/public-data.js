window.OD_PUBLIC_DATA = {
  meta: {
    ...
    updated: 'September 8, 2026: NYS DOL confirmed receipt of the signed ES161.2 Business Strategy submitted through Secure Messaging September 5 at 9:55 PM and identified the ISVF as the next form due September 21. VBOC at McNulty Center issued a provider completion certificate confirming Peter Vazquez completed the 1-hour Morning Coffee with Amy webinar on September 8; it remains verified supplemental training and is not counted toward the SEAP 20-hour total unless SEAP approves eligibility or a class change. Business-account control was also completed for Google Analytics, Search Console, and AdSense under peter@meaningmadeknown.com; Google Tag Manager had no accounts or containers to transfer. Google tag health was reconciled, and current CRM metrics are 44 prospect records, 27 personalized contacts, $8,200 active pipeline, 3 completed discovery calls, 8 proposals, 1 won barter client, and $0 collected cash revenue.'
  },
  metrics: { prospects: 44, pipeline: 8200, trainingLogged: 11.22, trainingPending: 9.22, trainingRequired: 20, contacts: 27 },
  purpose: [
